...
/**
 * Created by Gheorghe on 12/13/2016.
 */
@Controller
public class CancelBookingController {

    @RequestMapping(value = {"/getbookingforcancel"})
    public void handlegetpaid(HttpServletRequest request, HttpServletResponse response) throws IOException, ParseException, ParseException{
    ...
    public void handleCancelBooking(HttpServletRequest request, HttpServletResponse response) throws IOException, ParseException, ParseException {
